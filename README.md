...
The developer of the QuickAdd plugin has created a preset menu for timers using QuickAdd. You can follow the instructions in the QuickAdd example docs [here](https://github.com/chhoumann/quickadd/blob/master/docs/Examples/Macro_TogglManager.md)
